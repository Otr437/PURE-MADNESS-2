...
router.post("/", (req: Request, res: Response) => {
  ...
  const definition = getAgentDefinition(agent_type);
  // Build system prompt from the full agent definition library
  ...
  const resolvedEnv   = environment || definition?.environment || "office-desk";
