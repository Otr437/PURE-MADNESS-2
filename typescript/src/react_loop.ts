...
// ── Trace types ───────────────────────────────────────────────────────────────
export type Thought    = { type: "thought";     content: string };
export type Action     = { type: "action";      tool: string; input: Record<string, unknown> };
export type Observation= { type: "observation"; content: string; error: boolean };
export type Answer     = { type: "answer";      content: string };
export type Step       = Thought | Action | Observation | Answer;
...
// ── Tool registry ─────────────────────────────────────────────────────────────
export type ToolFn = (input: Record<string, unknown>) => Promise<string> | string;
...
export const toolRegistry: Map<string, ToolFn> = new Map();
export const toolSchemas:  ToolSchema[] = [];

export function registerTool(schema: ToolSchema, fn: ToolFn) {
